...
def send_confirmation(booking, email, pw):
    ...
    msg['From'] = my_email
    msg['To'] = send_to
    msg['Subject'] = 'Abdul Ladha Science Student Centre Bookings Confirmation #'+ str(booking['number'])
    ...
    sol_body = """\
        ...
        <div class="gmail_default">
        <div class="gmail_default"><strong>Invoice #"""+str(booking['number'])+' '+ booking['eventname'] +""" --&nbsp;</strong><strong>"""+ booking['date'] +' '+ booking['starttime'] + ' - ' + booking['endtime'] +"""</strong></div>
        ...
        <p>&nbsp;</p>
        <p>In this email, I have attached the&nbsp;Premises&nbsp;Use and Services Agreement&nbsp;and&nbsp;Rental Terms and Conditions&nbsp;documents, which need to be signed and&nbsp;scanned&nbsp;back to me 2 weeks prior to the event date,&nbsp;via&nbsp;email. Your booking qualifies as an&nbsp;<strong>"""+booking['type']+"""&nbsp;</strong>and the total rental fee is outlined in the attached invoice&nbsp;(excluding the Deposit).&nbsp;The building damage fee will be charged should any damages be made after the event.&nbsp;</p>
        <div>&nbsp;</div>
        </div>
        </div>
        </div>
    ...
    inv = 'Invoices/Invoice '+str(booking['number'])+'.pdf'
